...
def main():
    ...
    threads = []
    for worker_id in range(25):
        t = threading.Thread(target=scan_range, args=(start_ip, end_ip, port, worker_id))
        threads.append(t)
        t.start()
